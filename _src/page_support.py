...
<section class="section band-dark" id="newsletter">
  <div class="container">
    <div class="split split--even" style="align-items:center">
      ...
      <div data-reveal>
        <form class="form card newsletter-card" action="mailto:info@digitaltrustfuturesfoundation.org" method="post" enctype="text/plain">
          <div class="field">
            ...
            <p class="hint">Until the newsletter platform is live, this opens your email client to send a subscribe
              request to <strong>info@digitaltrustfuturesfoundation.org</strong>.</p>
          </div>
