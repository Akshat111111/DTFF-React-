...
const PATHWAYS = [
  { id: 'partner', icon: 'globe' as const, title: 'Governments and DPI programme teams', desc: 'National identity authorities, central banks and payment regulators, ministries of ICT and digital transformation, data-protection and AI regulators, national cybersecurity agencies, and service-delivery ministries.', offers: ['DPI trust readiness assessment', 'Safeguards accelerator support', 'AI governance review', 'Incident readiness and resilience support'], label: 'Government / DPI programme' },
  { id: 'support', icon: 'branch' as const, title: 'Digital public goods and open-source maintainers', desc: 'Maintainers of identity platforms, data-exchange layers, social protection systems, health registries, payment platforms and consent tooling.', offers: ['Security baseline review', 'SBOM and supply-chain support', 'Vulnerability disclosure process', 'Sustainability and governance advisory'], label: 'Digital public good / open source' },
  { id: 'funders', icon: 'chart' as const, title: 'Funders and development partners', desc: 'Philanthropic foundations, multilateral and bilateral donors, development finance institutions and DPI financing facilities.', offers: ['Two-year launch investment package', 'Programme-specific funding', 'Fellowship and fund sponsorship', 'Co-designed measurement and reporting'], label: 'Funding / partnership' },
