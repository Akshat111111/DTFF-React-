...
export const DIVISIONS: Record<string, Division> = {
  'dpi-trust-lab': {
    ...
    programmes: [
      { name: 'DPI Trust Readiness Assessment', desc: 'A structured, evidence-based review of whether a national DPI deployment is ready to carry population-scale trust.' },
      ...
      { name: 'Digital Identity and Credential Safety Programme', desc: 'Identity, biometric and credential safeguards, from enrolment through revocation and recovery.' },
      ...
      { name: 'AI Governance for Public Infrastructure Programme', desc: 'Oversight, appeal and incident-response practice for AI embedded in public services.' },
      ...
      { name: 'African DPI Trust Observatory', desc: 'Comparative, published evidence on DPI trust conditions across the region.' },
    ],
    ...
    extraRows: [
      ...
      { label: 'Digital public goods', desc: 'Secure development, SBOM readiness, dependency risk, vulnerability disclosure, patching obligations and shared exposure.' },
    ...
    boundary: 'The Lab does not replace national cybersecurity functions or commercial audits. It provides a practical, nonprofit assurance layer focused on citizen-facing public infrastructure and reusable open tools.',
  },
  ...
  'open-digital-commons': {
    ...
    strap: 'Creating, hosting, securing and sustaining digital public goods used in public-interest service delivery.',
    purpose: 'To support the open-source digital public goods that underpin identity, payments, data exchange, health, education and social protection systems — with a focus on the security, software trust and long-term sustainability of components that carry national-scale dependency but are frequently maintained without dedicated assurance or funding.',
    ...
    programmes: [
      { name: 'DPG Security Baseline Programme', desc: 'Structured security baseline reviews for digital public goods in active national deployment.' },
    ...
    extraRows: [
      ...
      { label: 'Social protection and beneficiary management', desc: 'Platforms determining who receives support, and when.' },
      { label: 'Health information and immunisation registries', desc: 'Systems holding some of the most sensitive population data.' },
  ...
  'policy-evidence-centre': {
    ...
    strap: 'Independent research translating technical risk into evidence for policy, regulation and public-interest technology decisions.',
    purpose: 'To produce and publish independent research that converts technical digital trust risk into evidence that funders, policymakers, regulators, DPI programme teams and civil society can act on — with particular emphasis on Africa and the Global South, where the evidence base is thinnest and the deployment pace is fastest.',
    ...
    focus: [
      ...
      { title: 'AI governance in public services', desc: 'How AI is being used in citizen-facing DPI, and what accountability, oversight and appeal mechanisms exist or are missing.' },
      { title: 'Digital identity and credential safety', desc: 'Privacy, exclusion, surveillance and systemic risk in national identity and credentialing systems.' },
      ...
      { title: 'Policy and regulatory evidence', desc: 'Evidence synthesis for DPI regulation, data protection, AI governance and open-source policy.' },
    ],
    programmes: [
      { name: 'Annual DPI Trust Report', desc: 'Flagship annual publication on DPI trust conditions across Africa and the Global South.' },
      ...
      { name: 'Policy Brief Series', desc: 'Short, decision-ready briefs on specific DPI, DPG and AI governance issues.' },
    ...
    extraRows: [
      ...
      { label: 'Comparative country analysis', desc: 'Cross-country comparison of DPI design, safeguards and outcome evidence.' },
    ...
    outputs: [
      ...
      'Policy briefs on DPI, DPG and AI governance',
  ...
  'skills-academy': {
    ...
    strap: 'Practical digital trust capacity building for governments, universities, civil society and local technology teams.',
    ...
    focus: [
      { title: 'Government and DPI teams', desc: 'Practical training for teams designing, procuring, operating and overseeing digital public infrastructure.' },
      { title: 'University and research integration', desc: 'Curriculum modules, case studies and research partnerships for universities with DPI and cybersecurity programmes.' },
      { title: 'Civil society capacity', desc: 'Digital safety, cyber hygiene and evidence-based advocacy training for nonprofit and community organisations.' },
      { title: 'Open-source community', desc: 'Secure development, disclosure and maintenance training for DPG and open-source maintainer communities.' },
    ],
    programmes: [
      { name: 'Digital Trust Research Fellowship', desc: 'Independent research on DPI risk, AI governance, credentials and open-source sustainability.' },
    ...
    extraRows: [
      ...
      { label: 'Language and accessibility', desc: 'Key materials produced or translated for low-literacy, multilingual and mobile-first environments.' },
    ],
    outputs: [
      'Open curriculum modules for DPI assurance and digital safety',
  ...
  'cyber-safety-centre': {
    ...
    strap: 'Practical cyber support for civil society, nonprofits and social-impact technology providers that cannot afford commercial services.',
    purpose: 'To provide affordable, right-sized cybersecurity and digital safety support for civil-society organisations, community institutions and social-impact technology providers — organisations that handle sensitive data and operate in high-risk digital environments but cannot access or afford commercial cybersecurity services.',
    audience: 'Civil-society organisations and nonprofits',
    contactEmail: 'info@digitaltrustfuturesfoundation.org',
    ...
    focus: [
      ...
      { title: 'Digital safety clinic', desc: 'Practical support for organisations working with vulnerable populations, handling sensitive data or operating in high-risk contexts.' },
      ...
      { title: 'Community safety toolkits', desc: 'Plain-language training and awareness materials for frontline community organisations and their beneficiaries.' },
    ],
    programmes: [
      { name: 'Civil Society Cyber Helpdesk', desc: 'First-response support for cyber incidents and digital safety emergencies affecting nonprofits and community institutions.' },
